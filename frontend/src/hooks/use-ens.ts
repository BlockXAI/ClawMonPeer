...
import { MONAD_TESTNET_CHAIN_ID } from '@/lib/wagmi'

// ENS chain ID — on Monad there's no ENS, but we keep the hooks for backward compat
...
export const ENS_RECORD_KEYS = {
  STRATEGY: 'com.monpeer.strategy',
  RISK: 'com.monpeer.risk',
  PAIRS: 'com.monpeer.pairs',
  MAX_ORDER: 'com.monpeer.maxOrder',
  ACTIVE: 'com.monpeer.active',
